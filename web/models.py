...
class Country(models.Model):
    name = models.CharField(max_length=500)
    status = models.CharField(choices=STATUS_TYPES, max_length=10, default='Enabled', null=True)
...
class City(models.Model):
    ...
    status = models.CharField(
        choices=STATUS_TYPES, max_length=10, default='Enabled', null=True)
    slug = models.SlugField(max_length=500, null=True)
...
class Project(models.Model):
    ...
    description = models.TextField(max_length=2000, default='', null=True)
...
class User(AbstractBaseUser):
    ...
    profile_description = models.CharField(max_length=2000, default='',null=True)
...
class JobPost(models.Model):
    ...
    status = models.CharField(choices=POST_STATUS, max_length=50, null=True)
    previous_status = models.CharField(
        choices=POST_STATUS, max_length=50, default='Draft', null=True)
...
class FacebookPost(models.Model):
    ...
    # TODO this must be choice field
    post_status = models.CharField(choices=POST_STATUS, max_length=50, null=True)
    is_active = models.BooleanField(default=False)
...
class AgencyResume(models.Model):
    ...
    uploaded_by = models.ForeignKey(User, on_delete=models.CASCADE)
    status = models.CharField(max_length=20, choices=POST, default='Pending', null=True)
...
class MailTemplate(models.Model):
    ...
    applicant_status = models.CharField(choices=POST_STATUS, max_length=50, null=True)
...
class SearchResult(models.Model):
    ...
    skills = models.ManyToManyField(Skill, related_name='skill_search', null=True)
...
class AgencyRecruiterJobposts(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    status = models.CharField(max_length=20, choices=AGENCY_RECRUITER_JOB_TYPE, default='Pending', null=True)
    job_post = models.ForeignKey(JobPost, on_delete=models.CASCADE)
    created_on = models.DateTimeField(auto_now=True, null=True)
...
class Question(models.Model):
    title = models.CharField(max_length=255)
    description = models.TextField(null=True)
    skills = models.ForeignKey(Skill, related_name='skill_questions', on_delete=models.CASCADE, null=True)
